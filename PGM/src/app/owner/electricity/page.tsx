...
export default function OwnerElectricityPage() {
  ...
  // ✅ Initialize electricity settings when component mounts
  useEffect(() => {
          ...
          >
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 shadow-xl border-0">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-blue-800">Total Bills</p>
            ...
            <Card className="bg-gradient-to-br from-orange-50 to-orange-100 shadow-xl border-0">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-orange-800">Pending Bills</p>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 shadow-xl border-0">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-green-800">Approved Bills</p>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 shadow-xl border-0">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-purple-800">Total Amount</p>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="ratePerUnit" className="text-gray-900 font-semibold">Rate per Unit (₹)</Label>
                      <Input
                        id="ratePerUnit"
                        type="number"
                        step="0.1"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="dueDate" className="text-gray-900 font-semibold">Due Date (Day of Month)</Label>
                      <Input
                        id="dueDate"
                        type="number"
                        min="1"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="lateFeePercentage" className="text-gray-900 font-semibold">Late Fee Percentage (%)</Label>
                      <Input
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="minimumUnits" className="text-gray-900 font-semibold">Minimum Units</Label>
                      <Input
                        id="minimumUnits"
                        type="number"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="maximumUnits" className="text-gray-900 font-semibold">Maximum Units</Label>
                      <Input
                        id="maximumUnits"
                        type="number"
                    ...
                    <div className="flex items-center space-x-3">
                      <Switch
                        ...
                        disabled={!isEditing}
                      />
                      <Label className="text-gray-900 font-semibold">Enable Electricity Billing</Label>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-blue-50 rounded-xl">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-blue-700">{settings.updatedAt || 'N/A'}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
